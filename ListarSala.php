...
// resgata variáveis do formulário
    ...
    <div><span style="position:absolute; display:block;text-align: center;
               ...
               margin:-5px 0 0 -10px; background-color:#9F81F7;border-radius: 5px;">Equipamento Removido.</span></div>
    
<?php }else{
    ?>
    <div><span style="position:absolute; display:block;text-align: center;
               top:20%; left:45%; width:150px; height:25px;
               margin:-5px 0 0 -10px; background-color:#9F81F7;border-radius: 5px;">Equipamento Não Removido.</span></div>
<?php }
        }
    }
